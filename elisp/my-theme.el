...
(deftheme my
  "Dark color theme with a black background")
...
(let* ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   'my
   '(default ((t (:family "Consolas" :foundry "nil" :width normal :weight normal :slant normal :underline nil :overline nil :strike-through nil :box nil :inverse-video nil :foreground "white" :background "#000000" :stipple nil :inherit nil))))
