...
(use-package PACKAGE
:init (...)                      initialization, always for deferred modules
:config (...)                    initialization, after deferred modules are loaded
:bind ("C-." . ace-jump-mode))   key binding, try M-x describe-personal-keybindings
:bind (("M-o l" . highlight-lines-matching-regexp)
       ("M-o r" . highlight-regexp)
       ("M-o w" . highlight-phrase))
:commands ace-jump-mode          create autoloads
:mode "\\.rb\\'"
:mode ("\\.py\\'" . python-mode)
:interpreter "ruby"
...
:defines empty-variable-definitions
...
(use-package dired
  ...
  :bind ("\C-x\C-d" . dired)  ;;ORIGINAL: list-directory
)
#+END_SRC
