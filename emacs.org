...
(eval-after-load "org-faces"
  '(progn (set-face-attribute 'org-level-2 nil :foreground "Blue1")
	  (set-face-attribute 'org-level-2 nil :foreground "Blue1")
	  (set-face-attribute 'org-level-3 nil :foreground "Blue1")
	  (set-face-attribute 'org-level-4 nil :foreground "Blue1")
	  (set-face-attribute 'org-level-5 nil :foreground "Blue1")
	  (set-face-attribute 'org-level-6 nil :foreground "Blue1")
	  (set-face-attribute 'org-level-7 nil :foreground "Blue1")
	  (set-face-attribute 'org-level-8 nil :foreground "Blue1")
	  ))
#+END_SRC
